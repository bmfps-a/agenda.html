...
while True :
        ...
        print('=' * 30)
        print(
            'Seja Bem-Vindo! Deseja entrar como Administrador ou Cliente ? (Escolha entre "c(cliente)" , "a(admin))" e s(sair) ')
        print('=' * 30)
        ...
        if escolha_usuario == 's' or escolha_usuario =='S':
            ...
            print('Observação! A máquina só aceita notas de 2, 5 e 10 reais, ou moedas de 1 real, 50, 25, 10 e 5 centavos!')
            print('AVISO!! A MÁQUINA POSSUI O LIMITE DE NO MAXIMO 50 REAIS DE TROCO NO TOTAL!')
            ...
            while dinheiro_do_cliente < precoRefri:
                dinheiro_do_cliente = float(input("Compra invalida, insira uma quantidade maior que 5 reais: "))
            ...
            if troco > 0:
                ...
                if troco_notas_10 > nota10_maquina:
                    troco_notas_10 = nota10_maquina
                nota10_maquina = nota10_maquina -  troco_notas_10
                troco = troco - (troco_notas_10 * 10)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco
                
                troco_notas_5 = int(troco / 5)
                if troco_notas_5 > nota5_maquina:
                    troco_notas_5 = nota5_maquina
                nota5_maquina = nota5_maquina -  troco_notas_5
                troco = troco - (troco_notas_5 * 5)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco
                

                troco_notas_2 = int(troco / 2)
                if troco_notas_2 > nota2_maquina:
                    troco_notas_2 = nota2_maquina
                nota2_maquina = nota2_maquina -  troco_notas_2
                troco = troco - (troco_notas_2 * 2)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco

                troco_moedas_1 = int(troco / 1)
                if troco_moedas_1 > moeda1real_maquina:
                    troco_moedas_1 = moeda1real_maquina
                moeda1real_maquina = moeda1real_maquina - troco_moedas_1
                troco = troco - troco_moedas_1
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco

                troco_moedas_50 = int(troco / 0.5)
                if troco_moedas_50 > moeda50c_maquina:
                    troco_moedas_50 = moeda50c_maquina
                moeda50c_maquina = moeda50c_maquina -  troco_moedas_50
                troco = troco - (troco_moedas_50 * 0.5)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco

                troco_moedas_25 = int(troco / 0.25)
                if troco_moedas_25 > moeda25c_maquina:
                    troco_moedas_25 = moeda25c_maquina
                moeda25c_maquina = moeda25c_maquina - troco_moedas_25
                troco = troco - (troco_moedas_25 * 0.25)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco

                troco_moedas_10 = int(troco / 0.10)
                if troco_moedas_10 > moeda10c_maquina:
                    troco_moedas_10 = moeda10c_maquina
                moeda10c_maquina = moeda10c_maquina - troco_moedas_10
                troco = troco - (troco_moedas_10 * 0.10)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco

                troco_moedas_5 = int(troco / 0.05)
                if troco_moedas_5 > moeda5c_maquina:
                    troco_moedas_5 = moeda5c_maquina
                moeda5c_maquina = moeda5c_maquina - troco_moedas_5
                troco = troco - (troco_moedas_5 * 0.05)
                dinheiro_maquina_inserido = dinheiro_maquina_inserido - troco
            ...
            if tentativa_senha == 1234:
                while True:
                    ...
                    if resposta_adm == 2:
                        ...
                        dinheiro_maquina_inserido = dinheiro_maquina_inserido + dinheiro_inserido

                        nota5_maquina = nota5_inserida + nota5_maquina
                        nota10_maquina = nota10_inserida + nota10_maquina 
                        nota2_maquina = nota2_maquina + nota2_inserida

                        moeda1real_maquina = moeda1real_maquina + moeda1real_inserida
                        moeda50c_maquina = moeda50c_maquina + moeda50c_inserida
                        moeda25c_maquina = moeda25c_maquina + moeda25c_inserida
                        moeda10c_maquina = moeda10c_maquina + moeda10c_inserida
                        moeda5c_maquina = moeda5c_maquina + moeda5c_inserida
